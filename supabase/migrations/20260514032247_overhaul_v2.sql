...
CREATE TABLE IF NOT EXISTS biochemical_records (
...
-- ── INDEXES V2 ──────────────────────────────────────────────
CREATE INDEX IF NOT EXISTS idx_biochem_patient ON biochemical_records(patient_id);
CREATE INDEX IF NOT EXISTS idx_biochem_date    ON biochemical_records(exam_date DESC);
CREATE INDEX IF NOT EXISTS idx_lifestyle_patient ON lifestyle_records(patient_id);
